...
const EmployeeAnalytics = ({data,loading}) => {

  const {countcustomer}= data
     ...
     <div className="flex gap-2 flex-col">
            ...
            <div>
              <div className="bg-orange-50 shadow w-full min-h-[250px] rounded-lg">
                ...
                <div className="flex flex-col md:flex-row md:justify-items-start gap-[340px] md:items-center px-5">
                ...
                <div className="px-5 py-3 overflow-x-auto styled-scrollbar">
                  <div className="flex gap-5 flex-nowrap md:flex-wrap justify-start md:justify-start min-w-max">
                    ...
                    {/* box4 */}
                    <div onClick={()=>handleleadstage("LEAD_WON")} className="bg-white cursor-pointer flex flex-col justify-center items-center w-[300px] h-[100px] border-l-4 border-green-500 rounded-lg shadow shrink-0">
                      <p className="text-gray-600 font-semibold text-md">
                        Lead Won
                      </p>
                    ...
                    {/* box5 */}
                    <div onClick={()=>handleleadstage("LEAD_LOST")} className="bg-white cursor-pointer flex flex-col justify-center items-center w-[300px] h-[100px] border-l-4 border-red-500 rounded-lg shadow shrink-0">
                      <p className="text-gray-600 font-semibold text-md">
                        Lead Lost
                      </p>
